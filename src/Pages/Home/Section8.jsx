...
const Section8 = () => {
  return (
    <div className="section-8 mx-[13px] md:mx-[30px] lg:mx-[70px] my-[100px]">
      ...
      <div className="mt-[50px] flex flex-col items-center md:items-start md:flex-row justify-between xl:justify-center gap-[50px] lg:gap-[35px] xl:gap-[50px]">
        <div className="w-[300px] md:w-[350px] flex flex-col justify-between items-center gap-[20px] md:gap-[50px]">
          ...
          <div className="px-[10px] flex flex-col justify-center gap-[5px]">
            ...
            <p className="text-[15px] font-[400] text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et</p>
          </div>
        </div>
        <div className="w-[300px] md:w-[350px] flex flex-col justify-between items-center gap-[20px] md:gap-[50px]">
          <div className="px:[20px] md:px-[35px] lg:px-[40px] xl:px-[60px] flex justify-center">
          ...
          <div className="px-[10px] flex flex-col justify-center gap-[5px]">
            <p className="text-[16px] font-[700] text-center">Web Plateform</p>
            <p className="text-[15px] font-[400] text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et</p>
          </div>
        </div>
        <div className="w-[300px] md:w-[350px] flex flex-col justify-between items-center gap-[20px] md:gap-[50px]">
