  ...
  return (
    <div className='section-2 px-[13px] md:px-[30px] lg:px-[70px] py-[80px] flex flex-col md:flex-row items-center'>
        <div className='md:w-[400px] lg:w-[600px]'>
            ...
            <div className='flex justify-center md:justify-start'><button className='mt-7 bg-[var(--main-text-color)] text-white text-[15px] font-[600] h-[40px] w-[220px] rounded-[5px] hover:scale-[1.01] active:scale-[0.999]'>List your home for sale</button></div>
