...
export const apiFavouriteHouses = async (data) => {
  try {
    ...
    const result = await axios.post(`${URL}/favourite-houses`, {
      userId,
      housesId: data,
    });
    return result;
...
export const getFavouriteHousesInfo = async (data) => {
  try {
    const result = await axios.post(`${URL}/favourite-houses/info`, {
      favouriteHouses: data,
    });
    return result;
  } catch (error) {
    return error;
...
export const getAgentRentalHouseById = async (id) => {
  try {
    const result = await axios.get(
      `${URL}/home-for-rent/by-agent/approved/${id}`
    );
    return result;
  } catch (error) {
    return error;
...
export const getAgentSaleHouseById = async (id) => {
  try {
    const result = await axios.get(
      `${URL}/home-for-sale/by-agent/approved/${id}`
    );
    return result;
  } catch (error) {
    return error;
...
export const connectWithLocalAgent = async (data) => {
  try {
    const result = await axios.post(
      `${URL}/user/connect-with-local-agent`,
      data
    );
    return result;
  } catch (error) {
