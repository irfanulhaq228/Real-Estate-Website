    ...
    <div className='section-1 px-[13px] md:px-[30px] lg:px-[70px] mt-[10px]'>
        <div style={{backgroundImage: `url(${img})`}} className='h-[470px] bg-cover rounded-[20px]'>
            <div className='h-[470px] w-full flex flex-col justify-center items-center bg-[rgba(0,0,0,0.5)] rounded-[20px] px-[5px] sm:px-[50px]'>
                ...
                <div className='flex justify-center'><button className='mt-10 bg-[var(--main-text-color)] text-white text-[15px] font-[600] h-[40px] w-[240px] rounded-[5px] hover:scale-[1.01] active:scale-[0.999]' onClick={() => navigate("/find-agent/connect-with-local-agent")}>Connect with a local agent</button></div>
            </div>
        </div>
    </div>
  )
